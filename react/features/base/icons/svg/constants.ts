...
import { default as IconVideoVibesObservation } from './icon-videovibes-observation.svg';
import { default as IconVideoVibesLearning } from './icon-videovibes-learning.svg';
...
export const DEFAULT_ICON: Record<string, any> = {
    ...
    IconWifi3Bars,
    IconYahoo,
    IconVideoVibesObservation,
    IconVideoVibesLearning
};
